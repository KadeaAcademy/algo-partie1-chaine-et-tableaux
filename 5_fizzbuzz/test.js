...
test('fizzBuzz est définie', () => {
  expect(fizzBuzz).toBeDefined();
});

test('Appel de la fonnction fizzbuzz avec `5` affiche 5 instructions', () => {
  fizzBuzz(5);
  expect(console.log.mock.calls.length).toEqual(5);
});

test('Appel de la fonction fizzbuzz avec 15 affiche les valeurs correctes', () => {
  fizzBuzz(15);
